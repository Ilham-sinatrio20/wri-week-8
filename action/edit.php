...
<?php
    if(isset($_POST['submit'])){
        ...
        if($res == true){
            $_SESSION ['delete'] = "<div class = 'alert alert-success' role='alert'>Driver successfully update</div>";
            header ('location:'.SITEURL.'index.php');
        }else{
            $_SESSION ['delete'] = "<div class = 'alert alert-danger' role='alert'>Driver failed to update</div>";
